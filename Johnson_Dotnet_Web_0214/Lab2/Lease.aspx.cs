    ...
    public partial class Lease : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (Session["customer"] != null)
            {
                ...
                var leaseHistory = CustomerDB.FindLeasingHistory(customer);
        ...
        protected void drpDockPicker_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (drpDockPicker.SelectedValue == "0")
                return;
                var availableSlips = SlipDB.GetAvailableSlipsFromDock(Convert.ToInt32(drpDockPicker.SelectedValue));
        ...
        protected void grdAvailableSlips_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "lease")
            {
                ...
                if (SlipDB.LeaseSelectedSlip(selectedSlip, currentCustomer))
                {
        ...
        protected void grdAvailableSlips_SelectedIndexChanged(object sender, EventArgs e)
        {
