...
<fieldset class="sectStyle">
    ...
    <div class="form-group">
        ...
        <div>
            ...
            <asp:RegularExpressionValidator ID="regexBusPhone" runat="server" ControlToValidate="txtBusinessPhone" ErrorMessage="Please enter a valid phone number with area code with no leading 1" ValidationExpression="\(?\d{3}\)?-? ?\d{3}-? ?\d{4}" Display="Dynamic"></asp:RegularExpressionValidator>            
        </div>
    </div>    
</fieldset>
        <!-- submit buttom-->
