...
<asp:Content ContentPlaceHolderID="head" runat="server">
    ...
    <style>
        ...
        #package1 {
            background-image: url("images/Caribbean travel2.jpg"); 
        }
        #package2 {
            background-image: url("images/polynesian travel.jpg"); 
            /*filter: grayscale(100%);*/
        }
        #package3 {
            background-image: url("images/china yangshuo2.jpg"); 
            /*filter: grayscale(100%);*/
        }
        #package4 {
    ...
    <ItemTemplate>
        <div class="packageTile" style="background-image: url('images/packagesImages/<%# Eval("PackageId") %>.jpg')">
            ...
            <div class="bottomRight">
                ...
                <br />
                <asp:Button ID="checkPackage" runat="server" Text="View Package" CommandName="select" />
            </div>
