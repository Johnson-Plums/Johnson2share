...
<asp:Content ContentPlaceHolderID="head" runat="server">
    <title>Pleasant Travel Agency Experts --- Booking History</title>
    ...
    <asp:DataList ID="DataList1" runat="server" DataSourceID="ObjectDataSource2" RepeatLayout="Flow">
        ...
        <div class="panel panel-default BookTile">
            ...
            <div class="panel-body form-row">
                <div class="col-sm-9">
                    Package ID: <asp:Label ID="PackageIdLabel" runat="server" Text='<%# Eval("PackageId") %>' /><br/>
                    Number Of Customers: <asp:Label ID="TravelerCountLabel" runat="server" Text='<%# Eval("TravelerCount") %>' />
                </div>
                <div class="col-sm-2">
                    Trip Type:
                    ...
                    <div class="panel-heading">
                        ...
                        <div class="form-row">
                            <div class="col-sm-8 text-right">
                                Fee Id: <asp:Label ID="FeeIdLabel" runat="server" Text='<%# Eval("FeeId") %>' />
                            </div>
                            <div class="col-sm-2">
                                Base Price: <asp:Label ID="BasePriceLabel" runat="server" Text='<%# Eval("BasePrice") %>' />
                            </div>
